      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="animate-enter" style={{animationDelay: '0.1s'}}>
            ...
            <div className="mt-12 flex items-center">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="inline-block h-10 w-10 rounded-full border-2 border-white bg-gray-200 overflow-hidden">
                    <img 
              ...
              <div className="ml-4">
                ...
                <div className="flex items-center mt-1">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Icon key={i} name="Star" className="h-4 w-4 text-yellow-400" />
                  ))}
          ...
          <div className="relative animate-enter" style={{animationDelay: '0.3s'}}>
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500 hover-scale">
              <img 
